"""
Django settings for apapa_43499 project.
...
WSGI_APPLICATION = 'apapa_43499.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "apapa_43499 API",
    "DESCRIPTION": "API documentation for apapa_43499 App",
    "VERSION": "v1",
}
